...
function App() {
    ...
    return (
        <>
            <main className="flex h-screen w-full flex-col items-center justify-center bg-stone-900 py-10 lg:py-0">
                ...
                <section className="mt-10 flex h-10 w-4/5 items-center justify-around">
                    ...
                    <div className="flex h-full w-2/3 items-center justify-center rounded-3xl bg-gray-300 lg:w-1/3 ">
                        <h1 className="font-mono  text-xs font-bold text-emerald-900 sm:text-sm lg:text-lg">
